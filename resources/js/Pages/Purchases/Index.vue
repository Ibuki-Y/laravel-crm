            ...
            <section class="text-gray-600 body-font">
              <div class="container px-5 py-8 mx-auto">
                ...
                <!-- <div class="flex pl-4 my-4 lg:w-2/3 w-full mx-auto">
                  <div>
                    <input class="mr-2 rounded-md" type="text" name="search" v-model="search" />
                    <button class="bg-blue-400 hover:bg-blue-500 text-white py-2 px-2" @click="searchCustomers">
                      検索
                    </button>
                  </div>
                </div> -->
                  ...
                  <table class="table-auto w-full text-left whitespace-no-wrap">
                    ...
                    <tbody>
                      <tr v-for="order in props.orders.data" :key="order.id">
                        ...
                        <td class="px-4 py-3">{{ Number(order.total).toLocaleString() }}</td>
              ...
              <PaginationVue class="mt-6 flex justify-center" :links="props.orders.links"></PaginationVue>
            </section>
          </div>
        </div>
      </div>
